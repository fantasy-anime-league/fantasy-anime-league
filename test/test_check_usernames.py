...
@vcr.use_cassette('test/fixtures/vcr_cassettes/check_usernames/check-username-failure.yaml')
...
@vcr.use_cassette('test/fixtures/vcr_cassettes/check_usernames/caps-username-success.yaml')
