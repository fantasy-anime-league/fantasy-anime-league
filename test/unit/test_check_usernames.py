...
@vcr.use_cassette('test/unit/vcr_cassettes/check_usernames/check-username-success.yaml')
...
@vcr.use_cassette('test/unit/vcr_cassettes/check_usernames/check-username-failure.yaml')
...
@vcr.use_cassette('test/unit/vcr_cassettes/check_usernames/caps-username-success.yaml')
