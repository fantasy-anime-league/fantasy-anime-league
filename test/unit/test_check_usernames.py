...
@vcr.use_cassette(f"{config['vcr']['path']}/check_usernames/check-username-success.yaml")
...
@vcr.use_cassette(f"{config['vcr']['path']}/check_usernames/check-username-failure.yaml")
...
@vcr.use_cassette(f"{config['vcr']['path']}/check_usernames/caps-username-success.yaml")
